...
async function run() {
  console.log('--- Updating About Us page with Logo Card & Attorney Bio ---');
...
<div class="page-content">
  <div class="section" style="margin-bottom: 40px; clear: both;">
    ...
    <div class="col span_1_of_2">
      <!-- Company logo card instead of wrong AI generated photo -->
  ...
  <div class="section" style="margin-top: 40px; padding-top: 30px; border-top: 1px solid #eaeaea; clear: both;">
    ...
    <div style="background: #fdfdfd; border: 1px solid #eaeaea; border-radius: 8px; padding: 25px; box-shadow: 0 2px 8px rgba(0,0,0,0.02);">
      <div style="display: flex; align-items: center; gap: 15px; margin-bottom: 15px;">
        <div style="width: 50px; height: 50px; background: rgba(15, 58, 98, 0.08); border-radius: 50%; display: flex; align-items: center; justify-content: center; color: #0f3a62; font-size: 1.5rem; font-weight: bold;">
          DAC
        </div>
        <div>
          <h3 style="margin: 0; font-size: 1.3rem; color: #0f3a62; font-weight: 700;">D. Anthony Calomeni</h3>
          <p style="margin: 0; font-size: 1rem; color: #888; font-weight: 600;">Attorney at Law</p>
        </div>
      </div>
      <p style="font-size: 1.05rem; line-height: 1.6; color: #555; margin: 0;">
...
`;
  ...
  console.log('About Us page updated successfully with Logo Card!');
  process.exit(0);
}
