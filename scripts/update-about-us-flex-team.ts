...
async function run() {
  console.log('--- Updating About Us page with Flexbox Equal-Height Team & Logo Avatars ---');
...
<div class="page-content">
  ...
  <!-- Team Section (DAC & AF Flex Equal Height with Logos) -->
    ...
    <div class="team-flex-container">
      <div class="team-card">
        <div style="display: flex; align-items: center; gap: 15px; margin-bottom: 15px;">
          <div class="team-logo-avatar">
            <img src="/assets/imported/logo-big.png" alt="Calomeni Logo" />
          </div>
          <div>
        ...
        <p style="font-size: 0.95rem; line-height: 1.6; color: #555; margin: 0; flex: 1;">
...
`;
  ...
  console.log('About Us page updated successfully with flex team & logo avatars!');
  process.exit(0);
}
